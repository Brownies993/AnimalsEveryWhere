$(document).ready(function() {
    ...
    var topics = ['wolf', 'tiger', 'lion', 'dolphin', 'penguin', 'eagle', 'snake', 'owl', 'lizards', 'turtle'];
    var url = ['https://api.giphy.com/v1/gifs/search?api_key=ra6fnsvXwq8HQnsI8EcNPpKCrhbkROFf'];
 ...
 for (var i = 0; i < topics.length; i++) {
  ...
  // Run this when button is clicked 
    ...
    function gifDisplay() {
        ...
        $('.results').append('<h2 class="results">Cool Animal: <span>' + $(this).data('name') + ' Gifs!</span></h2>' );
